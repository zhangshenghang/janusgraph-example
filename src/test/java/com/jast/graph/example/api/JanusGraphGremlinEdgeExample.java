...
public class JanusGraphGremlinEdgeExample {
	...
	public void test() {
		...
		Vertex article1 = g.addV("article").property("name", "语文星光").property("uid", 123456789l).property("city", "未知").property("url", "https://test.com/123456789/").next();
		Vertex article2 = g.addV("article").property("name", "ling001972").property("uid", 6430029562l).property("city", "未知").property("url", "https://test.com/123456789/").next();
		Vertex article3 = g.addV("article").property("name", "山中野猫m").property("uid", 6051786224l).property("city", "未知").property("url", "https://test.com/123456789/").next();
		Vertex article4 = g.addV("article").property("name", "县红i能品面_eQ").property("uid", 7367894775l).property("city", "未知").property("url", "https://test.com/123456789/").next();
		Vertex article5 = g.addV("article").property("name", "日长k叫门伟_").property("uid", 7367894771l).property("city", "未知").property("url", "https://test.com/123456789/").next();
		Vertex article6 = g.addV("article").property("name", "用户6384977836").property("uid", 7361237622l).property("city", "未知").property("url", "https://test.com/123456789/").next();
		Vertex article7 = g.addV("article").property("name", "唱悲殇乄吕LQQ").property("uid", 6384977836l).property("city", "未知").property("url", "https://test.com/123456789/").next();
		Vertex article8 = g.addV("article").property("name", "我还是觉得我的名字不够洋气").property("uid", 3964098185l).property("city", "未知").property("url", "https://test.com/123456789/").next();
		Vertex article9 = g.addV("article").property("name", "不冫令").property("uid", 7005136440l).property("city", "未知").property("url", "https://test.com/123456789/").next();
		Vertex article10 = g.addV("article").property("name", "无敌风火轮").property("uid", 2664293327l).property("city", "未知").property("url", "https://test.com/123456789/").next();
